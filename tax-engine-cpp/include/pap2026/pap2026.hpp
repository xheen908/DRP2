...
public:
  ...
  long long MBV =
      0; ///< Nicht zu besteuernde Vorteile bei Vermögensbeteiligungen (Cent)
...
private:
  // --- Interne Felder ---
  double ALTE = 0.0, ANP = 0.0, BMG = 0.0, DIFF = 0.0, EFA = 0.0, FVB = 0.0,
         FVBSO = 0.0, FVBZ = 0.0, FVBZSO = 0.0, GFB = 0.0, HBALTE = 0.0,
         HFVB = 0.0, HFVBZ = 0.0, HFVBZSO = 0.0, HOCH = 0.0;
  int J = 0, K = 0;
  double BBGRVALV = 0.0, AVSATZAN = 0.0, BBGKVPV = 0.0, VFRB = 0.0;
  double JBMG = 0.0, JLFREIB = 0.0, JLHINZU = 0.0, JW = 0.0, KFB = 0.0,
         KVSATZAN = 0.0, KZTAB = 1.0, LSTJAHR = 0.0, LSTOSO = 0.0, LSTSO = 0.0,
         MIST = 0.0, PKPVAGZJ = 0.0, PVSATZAN = 0.0, RVSATZAN = 0.0, RW = 0.0,
         SAP = 0.0, SOLZFREI = 0.0, SOLZJ = 0.0, SOLZMIN = 0.0, SOLZSBMG = 0.0,
         SOLZSZVE = 0.0, ST = 0.0, ST1 = 0.0, ST2 = 0.0;
  double VBEZB = 0.0, VBEZBSO = 0.0, VERGL = 0.0, VSPHB = 0.0, VSP = 0.0,
         VSPN = 0.0, VSPALV = 0.0, VSPKVPV = 0.0, VSPR = 0.0, W1STKL5 = 0.0,
         W2STKL5 = 0.0, W3STKL5 = 0.0, X = 0.0, Y = 0.0, ZRE4 = 0.0,
         ZRE4J = 0.0, ZRE4VP = 0.0, ZRE4VPR = 0.0, ZTABFB = 0.0, ZVBEZ = 0.0,
         ZVBEZJ = 0.0, ZVE = 0.0, ZX = 0.0, ZZX = 0.0;
